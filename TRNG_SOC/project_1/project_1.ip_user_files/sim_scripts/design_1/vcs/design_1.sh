...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_19 processing_system7_vip_v1_0_21 xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 xlconstant_v1_1_9 smartconnect_v1_0 axi_register_slice_v2_1_33)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/user23/data/TRNG/TRNG_SOC/project_1/project_1.cache/compile_simlib/vcs"
  fi

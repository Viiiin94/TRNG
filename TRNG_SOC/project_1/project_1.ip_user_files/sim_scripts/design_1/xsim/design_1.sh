...
export RDI_DATADIR="/media/user23/data/tools/xilinx/Vivado/2024.2/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/user23/data/tools/xilinx/Vivado/2024.2/data/xsim"
  fi

namespace eval ::optrace {
  variable script "/media/user23/data/TRNG/TRNG_SOC/project_1/project_1.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /media/user23/data/TRNG/TRNG_SOC/project_1/project_1.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /media/user23/data/TRNG/TRNG_SOC/project_1/project_1.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc /media/user23/data/TRNG/TRNG_SOC/project_1/project_1.srcs/constrs_1/imports/new/Zybo-Z7-Master.xdc

...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=3,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_board_cnt=1,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]aes256_decrypt_0_bram_addra;
  wire aes256_decrypt_0_bram_clka;
  wire aes256_decrypt_0_bram_ena;
  wire [31:0]aes256_encrypt_0_bram_addrb;
  wire aes256_encrypt_0_bram_clkb;
  wire [31:0]aes256_encrypt_0_bram_dinb;
  wire aes256_encrypt_0_bram_enb;
  wire aes256_encrypt_0_bram_rstb;
  wire [3:0]aes256_encrypt_0_bram_web;
  wire aes256_encrypt_0_key_ready_out;
  wire aes256_encrypt_0_key_reload_out;
  ...
  wire [255:0]myip_trng256_0_rand_data_out;
  wire myip_trng256_0_rand_valid_key;
  ...
  design_1_aes256_decrypt_0_0 aes256_decrypt_0
       (.bram_addra(aes256_decrypt_0_bram_addra),
        .bram_clka(aes256_decrypt_0_bram_clka),
        .bram_douta(blk_mem_gen_0_douta),
        .bram_ena(aes256_decrypt_0_bram_ena),
        .key_ready_in(aes256_encrypt_0_key_ready_out),
        .key_reload_in(aes256_encrypt_0_key_reload_out),
  ...
  design_1_aes256_encrypt_0_1 aes256_encrypt_0
       (.bram_addrb(aes256_encrypt_0_bram_addrb),
        .bram_clkb(aes256_encrypt_0_bram_clkb),
        .bram_dinb(aes256_encrypt_0_bram_dinb),
        .bram_doutb(blk_mem_gen_0_doutb),
        .bram_enb(aes256_encrypt_0_bram_enb),
        .bram_rstb(aes256_encrypt_0_bram_rstb),
        .bram_web(aes256_encrypt_0_bram_web),
        .key_ready_out(aes256_encrypt_0_key_ready_out),
        .key_reload_out(aes256_encrypt_0_key_reload_out),
        .rand_data(myip_trng256_0_rand_data_out),
        .rand_valid(myip_trng256_0_rand_valid_key),
        .s00_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x42000000 32 > design_1 blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra(aes256_decrypt_0_bram_addra),
        .addrb(aes256_encrypt_0_bram_addrb),
        .clka(aes256_decrypt_0_bram_clka),
        .clkb(aes256_encrypt_0_bram_clkb),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(aes256_encrypt_0_bram_dinb),
        .douta(blk_mem_gen_0_douta),
        .doutb(blk_mem_gen_0_doutb),
        .ena(aes256_decrypt_0_bram_ena),
        .enb(aes256_encrypt_0_bram_enb),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(aes256_encrypt_0_bram_rstb),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(aes256_encrypt_0_bram_web));
  design_1_myip_trng256_0_0 myip_trng256_0
       (.rand_data_out(myip_trng256_0_rand_data_out),
        .rand_valid_key(myip_trng256_0_rand_valid_key),
        .s00_axi_aclk(processing_system7_0_FCLK_CLK0),
